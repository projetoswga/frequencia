...
public class ApplicationProperties {
		...
		try {
			...
			while (resources.hasMoreElements()) {
		    	...
		    	if (manifest.getMainAttributes().getValue("Built-By") != null 
		    			&& manifest.getMainAttributes().getValue("Built-By").equals("ESAF - Escola de Administração Fazendária")){ 
	...
	public static URL getURLLogo() { 
        URL imageURL = ApplicationProperties.class.getClassLoader().getResource("imagens/esaf-logo.png");  
        return imageURL;  
    }
}
